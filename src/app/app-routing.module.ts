...
const routes: Routes = [
  ...
  {path: 'organisation', component: InstitutionManagementComponent, canActivate: [authOnlyGuardGuard]},
  {path: 'etudiant/choix', component: ChoixClasseGroupeComponent, canActivate: [authOnlyGuardGuard]}
];
